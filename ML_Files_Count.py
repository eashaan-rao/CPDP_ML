            ...
            if file.endswith(".py"):  # Adjust the extension as needed
            	...
            	with open(os.path.join(root, file), 'r', errors='ignore') as f:
                    ...
                    if file not in processed_files and any(keyword in content for keyword in keywords):
                        ...
                        #jax_main_index = relative_path.find(project_folder)
                        #if jax_main_index != -1:
                        #    relative_path = relative_path[jax_main_index+1:]  # Exclude the path before the name of project_folder
...
yolov5_directory = '/home/user/CS21D002_A_Eashaan_Rao/Research/CPDP/MSR_2024/Dataset/yolov5-versions/yolov5-7.0'
