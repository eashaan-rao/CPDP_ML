...
input_csv_file = '../Dataset_ML_Files/jax_ml_files.csv'  # Replace with the path to your input CSV file
input_files = set()
...
project_directory = '../Dataset/ML Project/jax'  # Specify your project directory
all_files = set()
...
output_csv_file = '../Dataset_ML_Files/jax_nonml_files.csv'  # Specify the output CSV file
